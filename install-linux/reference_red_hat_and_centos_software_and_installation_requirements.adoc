...
* Red Hat Enterprise Linux 7.x 版和 8.0 至 8.7 版、以 x86_64 架構為基礎。
...
* MySQL Community Edition 8.0.32 版（來自 MySQL 儲存庫）。
* OpenJDK 11.0.18 版（來自 Red Hat Extra Enterprise Linux Server 儲存庫）
* Python 3.6.x
