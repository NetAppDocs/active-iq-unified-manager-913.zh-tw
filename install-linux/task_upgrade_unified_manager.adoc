...
[role="lead"]
您可以下載並執行 Linux 平台上的安裝檔案、從 Unified Manager 9.11 或 9.12 升級至 9.13 。
...
* MySQL Community Edition會在Unified Manager升級期間自動升級。如果系統上安裝的 MySQL 版本早於 8.0.32 、 Unified Manager 升級程序會自動將 MySQL 升級至 8.0.32 。
